...
| Package | `Cargo.toml` | Version `0.1.235`, multi-crate Cargo workspace (`fog-of-intent`, `crates/foi-kernel`, `crates/foi-lane`, `crates/foi-map`, `crates/foi-agent`), one deferred edge crate (`reedline`) |
