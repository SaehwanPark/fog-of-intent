...
| Package | `Cargo.toml` | Version `0.1.236`, multi-crate Cargo workspace (`fog-of-intent`, `crates/foi-kernel`, `crates/foi-lane`, `crates/foi-map`, `crates/foi-agent`, `crates/foi-protocol`), one deferred edge crate (`reedline`) |
