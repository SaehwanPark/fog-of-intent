...
| Package | `Cargo.toml` | Version `0.1.128`, no dependencies |
...
12 session tests, and 34 host tests within the 230-unit, 7-binary, and
...
- [ ] Implement a local batch runner and resumable run directory.
  Deterministic in-process manifest batches are delivered; resumable storage
  remains open.
