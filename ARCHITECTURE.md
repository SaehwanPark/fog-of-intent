...
borrows payload text, but it does not render, authorize, persist, or invoke the
simulation.
...
- M3 has a typed command grammar only; terminal I/O, host lifecycle, domain
  mapping, and transcript execution remain open.
