...
| Rust package | `0.1.58`, edition 2024, Rust `1.96`, no dependencies, single package |
...
| CLI reference experience | Stable grammar plus typed observe/inspect/help reads; terminal host and flows not implemented |
