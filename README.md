...
| Rust package | `0.1.166`, edition 2024, Rust `1.96`, no dependencies, single package |
...
rejection category. Exploit-seeking and communication-abuse populations,
actual adversarial search, prevalence, outcomes, and human behavior remain
open.
