...
| Rust package | `0.1.92`, edition 2024, Rust `1.96`, no dependencies, single package |
...
| Agent ecology and MCP | Three actor-visible deterministic scripted profiles with transparent policy-role IDs, matched-input evidence, bounded comparison and action-tally reports plus candidate-breadth evidence, and an opt-in reproducible seed bundle for top-1 ties; broader ecology and MCP remain open — M4/M5 |
