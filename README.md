...
| Rust package | `0.1.127`, edition 2024, Rust `1.96`, no dependencies, single package |
...
| Behavioral experiments and calibration | Versioned bounded experiment manifest metadata; batch execution and calibration remain open — M6/M7 |
