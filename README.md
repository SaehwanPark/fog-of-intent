...
| Rust package | `0.1.81`, edition 2024, Rust `1.96`, no dependencies, single package |
...
| Agent ecology and MCP | Two actor-visible deterministic scripted profiles (`cautious-laner-v1` and `risk-taking-laner-v1`) with one matched-input comparison; broader ecology and MCP remain open — M4/M5 |
