...
| Rust package | `0.1.161`, edition 2024, Rust `1.96`, no dependencies, single package |
...
chunk and finish. It is not causal-trace completeness or replay-identity
verification; runtime production and recovery remain open.
