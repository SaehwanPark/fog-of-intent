...
| Rust package | `0.1.65`, edition 2024, Rust `1.96`, no dependencies, single package |
...
| CLI reference experience | Stable grammar plus typed top-level/read/write/process/session adapter requests, interaction modes, verbosity policies, privilege guards, information-label vocabulary, and pre-commit draft/undo boundary; terminal host and flows not implemented |
