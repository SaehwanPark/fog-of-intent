...
| Rust package | `0.1.68`, edition 2024, Rust `1.96`, no dependencies, single package |
...
| CLI reference experience | Stable grammar plus typed requests, labels, draft/undo, run IDs, and a bounded in-memory two-window host transcript; terminal renderer and persistent flows remain open |
