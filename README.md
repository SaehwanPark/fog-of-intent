...
| Rust package | `0.1.79`, edition 2024, Rust `1.96`, no dependencies, single package |
...
| Agent ecology and MCP | One actor-visible deterministic `cautious-laner-v1` scripted baseline; broader ecology and MCP remain open — M4/M5 |
