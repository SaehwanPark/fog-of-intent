...
| Rust package | `0.1.227`, edition 2024, Rust `1.96`, one deferred edge crate (`reedline`), single package |
...
| CLI reference experience | Complete — M3; TTY prompt, Tab completion, optional color, dynamic interactive scenario selection (`--select`), scenario catalog discovery (`--list-scenarios`), and `help`/`?` topics; pipes stay labeled plain text. Strategy, behavioral experiments, team benchmark, study synthesis, and match scenario selections available |
