...
| Rust package | `0.1.207`, edition 2024, Rust `1.96`, one deferred edge crate (`reedline`), single package |
...
| Full match, human alpha, optional GUI | M9 complete match library and CLI replay transcript exist; M10 study protocol, participant cohort schema, dimension assessments, interaction audits, informal check remediation, sampling limits, and alpha synthesis framework library contracts exist; human empirical testing and GUI are not implemented — M10-M11 |
