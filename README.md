...
| Rust package | `0.1.195`, edition 2024, Rust `1.96`, one deferred edge crate (`reedline`), single package |
...
| Full match, human alpha, optional GUI | M9 map topology, travel, objective cycles, vision control, team compositions, structures hierarchy, match victory, and role observations/actions/debriefs library contracts exist; complete match, human alpha, and GUI are not implemented — M9-M11 |
