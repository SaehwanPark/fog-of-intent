...
| Rust package | `0.1.149`, edition 2024, Rust `1.96`, no dependencies, single package |
...
deterministic safe/threat alternation from a caller-supplied starting
observation ID; it does not sample a broad population or claim distributional,
outcome, or human-behavior evidence.
