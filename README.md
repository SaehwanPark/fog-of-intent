...
| Rust package | `0.1.216`, edition 2024, Rust `1.96`, one deferred edge crate (`reedline`), single package |
...
| Public alpha | Library-only M12 release governance manifest evaluation, policy compliance, cross-version compatibility matrix, data dictionary redaction auditing, known limitations / evidence boundaries / citation guidance, documentation guides DAG verification, sample reproducibility bundle packaging, and benchmark catalog library contracts exist; release candidate testing and research archiving remain open — M12 |
