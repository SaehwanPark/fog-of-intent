...
| Rust package | `0.1.61`, edition 2024, Rust `1.96`, no dependencies, single package |
...
| CLI reference experience | Stable grammar plus typed read/write/process/session adapter requests; terminal host and flows not implemented |
