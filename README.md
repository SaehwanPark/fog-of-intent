...
| Rust package | `0.1.233`, edition 2024, Rust `1.96`, one deferred edge crate (`reedline`), multi-crate Cargo workspace (`fog-of-intent`, `crates/foi-kernel`, `crates/foi-lane`) |
