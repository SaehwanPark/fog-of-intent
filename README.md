...
| Rust package | `0.1.214`, edition 2024, Rust `1.96`, one deferred edge crate (`reedline`), single package |
...
| Public alpha | Library-only M12 release governance manifest evaluation, policy compliance, cross-version compatibility matrix, data dictionary redaction auditing, and benchmark catalog library contracts exist; public release packaging and research archiving remain open — M12 |
