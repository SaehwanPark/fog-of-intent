...
| CLI reference experience | Stable grammar plus typed top-level/read/write/process/session adapter requests, interaction modes, verbosity policies, and privilege guards; terminal host and flows not implemented |
