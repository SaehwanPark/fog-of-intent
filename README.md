...
> **Project status:** Modular Rust workspace (`0.1.244`) featuring a deterministic
...
| Rust package | `0.1.244`, edition 2024, Rust `1.96`, one deferred edge crate (`reedline`), multi-crate Cargo workspace (`fog-of-intent`, `crates/foi-kernel`, `crates/foi-lane`, `crates/foi-map`, `crates/foi-agent`, `crates/foi-protocol`, `crates/foi-study`, `crates/foi-gui`, `crates/foi-alpha`) |
