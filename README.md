...
| Rust package | `0.1.8`, edition 2024, Rust `1.96`, no dependencies, single package |
| Executable behavior | Prints `Hello, world!` |
| Deterministic kernel | M1 fixture/codec complete; M2 window, branch, coordination, objective, and strategy fixtures implemented internally |
| One-lane scenario | First diagnostic window, bounded branch, allied proposal/coordination, terminal objective, and three matched-input strategy fixtures implemented — full scenario not complete |
