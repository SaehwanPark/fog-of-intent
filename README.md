...
| Agent ecology and MCP | Three actor-visible deterministic scripted profiles (`cautious-laner-v1`, `risk-taking-laner-v1`, and `yielding-laner-v1`) with matched-input evidence; broader ecology and MCP remain open — M4/M5 |
