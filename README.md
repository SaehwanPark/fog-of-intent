...
| Rust package | `0.1.77`, edition 2024, Rust `1.96`, no dependencies, single package |
| Executable behavior | Reports package version with standalone `--version`/`-V`, or runs the line-oriented deterministic two-window fixture loop with explicit versioned `--scenario m3-two-window-fixture-v1` selection and optional `--run-dir` artifact storage |
