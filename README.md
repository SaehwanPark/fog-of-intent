...
| Rust package | `0.1.84`, edition 2024, Rust `1.96`, no dependencies, single package |
...
| Agent ecology and MCP | Three actor-visible deterministic scripted profiles with matched-input evidence and a bounded comparison report; broader ecology and MCP remain open — M4/M5 |
