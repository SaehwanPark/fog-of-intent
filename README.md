...
| Rust package | `0.1.7`, edition 2024, Rust `1.96`, no dependencies, single package |
| Executable behavior | Prints `Hello, world!` |
| Deterministic kernel | M1 fixture/codec complete; M2 window, branch, coordination, and objective overlay implemented internally |
| One-lane scenario | First diagnostic window, bounded branch, allied proposal/coordination, and one terminal-objective review implemented — full scenario not complete |
