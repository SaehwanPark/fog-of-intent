...
The implementation provides one focused protocol codec test. The expected full
evidence is 228 Rust unit tests, 7 binary tests, and 3 RustDoc tests, with 26
