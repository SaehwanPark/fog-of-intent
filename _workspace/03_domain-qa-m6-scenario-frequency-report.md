...
repeated construction, and the singleton safe=1/River=0 boundary. The full
evidence is one focused report test within 23 focused agent tests, 236 Rust
...
all pass at reviewed head `eee3861`.
