...
3. Score a visible threat response at 100, `Stabilize` at 80 plus the observed
   ...
   0–3 by the lane observation contract.
...
The profile is an inspectable baseline for policy plumbing, one actor-visible
utility feature, and information boundaries. Its scores are fixtures, not a
balance model or strategic-quality claim. There is no memory, communication,
random stream, candidate sampling,
