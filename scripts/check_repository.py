...
CORE_RUST_FILES = (
  ...
  "src/alpha/mod.rs",
  "src/gui/mod.rs",
  "crates/foi-agent/src/attribution.rs",
  "crates/foi-agent/src/communication.rs",
  "crates/foi-agent/src/comparison.rs",
  "crates/foi-agent/src/debrief.rs",
  "crates/foi-agent/src/disagreement.rs",
  "crates/foi-agent/src/empirical.rs",
  "crates/foi-agent/src/experiment.rs",
  "crates/foi-agent/src/held_out.rs",
  "crates/foi-agent/src/leadership.rs",
  "crates/foi-agent/src/lib.rs",
  "crates/foi-agent/src/measures.rs",
  "crates/foi-agent/src/multi_model.rs",
  "crates/foi-agent/src/operational.rs",
  "crates/foi-agent/src/parametric.rs",
  "crates/foi-agent/src/policy.rs",
  "crates/foi-agent/src/population.rs",
  "crates/foi-agent/src/profile.rs",
  "crates/foi-agent/src/recalibration.rs",
  "crates/foi-agent/src/reference_output.rs",
  "crates/foi-agent/src/replay.rs",
  "crates/foi-agent/src/scenarios.rs",
  "crates/foi-agent/src/semantic.rs",
  "crates/foi-agent/src/simultaneous.rs",
  "crates/foi-agent/src/tally.rs",
  "crates/foi-agent/src/team_plan.rs",
  "crates/foi-agent/src/trust.rs",
  "crates/foi-agent/src/uncertainty.rs",
  "crates/foi-alpha/src/archive.rs",
  "crates/foi-alpha/src/catalog.rs",
  "crates/foi-alpha/src/checks.rs",
  "crates/foi-alpha/src/compatibility.rs",
  "crates/foi-alpha/src/data_dictionary.rs",
  "crates/foi-alpha/src/governance.rs",
  "crates/foi-alpha/src/guides.rs",
  "crates/foi-alpha/src/lib.rs",
  "crates/foi-alpha/src/limitations.rs",
  "crates/foi-alpha/src/reproducibility.rs",
  "crates/foi-gui/src/asset.rs",
  "crates/foi-gui/src/asset_catalog.rs",
  "crates/foi-gui/src/browser.rs",
  "crates/foi-gui/src/browser_catalog.rs",
  "crates/foi-gui/src/catalog.rs",
  "crates/foi-gui/src/dto.rs",
  "crates/foi-gui/src/html.rs",
  "crates/foi-gui/src/html_catalog.rs",
  "crates/foi-gui/src/lib.rs",
  "crates/foi-gui/src/need.rs",
  "crates/foi-gui/src/parity.rs",
  "crates/foi-gui/src/projection.rs",
  "crates/foi-gui/src/state.rs",
  "crates/foi-gui/src/state_catalog.rs",
  "crates/foi-gui/src/transport.rs",
  "crates/foi-gui/src/transport_catalog.rs",
  ...
  "src/kernel/mod.rs",
  "crates/foi-lane/src/branch.rs",
  "crates/foi-lane/src/coordination.rs",
  "crates/foi-lane/src/encoding.rs",
  "crates/foi-lane/src/evaluation.rs",
  "crates/foi-lane/src/history.rs",
  "crates/foi-lane/src/intent.rs",
  "crates/foi-lane/src/lib.rs",
  "crates/foi-lane/src/objective.rs",
  "crates/foi-lane/src/observation.rs",
  "crates/foi-lane/src/projection.rs",
  "crates/foi-lane/src/result.rs",
  "crates/foi-lane/src/scenario.rs",
  "crates/foi-lane/src/state.rs",
  "crates/foi-lane/src/transition.rs",
  "crates/foi-lane/src/validation.rs",
  "crates/foi-lane/src/values.rs",
  "src/lane/mod.rs",
  "crates/foi-map/src/catalog.rs",
  "crates/foi-map/src/comeback.rs",
  "crates/foi-map/src/comeback_catalog.rs",
  "crates/foi-map/src/complete_match.rs",
  "crates/foi-map/src/complete_match_catalog.rs",
  "crates/foi-map/src/composition.rs",
  "crates/foi-map/src/contest.rs",
  "crates/foi-map/src/cost_profile.rs",
  "crates/foi-map/src/decision_density.rs",
  "crates/foi-map/src/decision_density_catalog.rs",
  "crates/foi-map/src/graph.rs",
  "crates/foi-map/src/lib.rs",
  "crates/foi-map/src/match_catalog.rs",
  "crates/foi-map/src/objective.rs",
  "crates/foi-map/src/objective_catalog.rs",
  "crates/foi-map/src/pivotal.rs",
  "crates/foi-map/src/pivotal_catalog.rs",
  "crates/foi-map/src/population_validation.rs",
  "crates/foi-map/src/population_validation_catalog.rs",
  "crates/foi-map/src/role_action.rs",
  "crates/foi-map/src/role_catalog.rs",
  "crates/foi-map/src/role_debrief.rs",
  "crates/foi-map/src/role_observation.rs",
  "crates/foi-map/src/state.rs",
  "crates/foi-map/src/structures.rs",
  "crates/foi-map/src/topology.rs",
  "crates/foi-map/src/transition.rs",
  "crates/foi-map/src/travel.rs",
  "crates/foi-map/src/victory.rs",
  "crates/foi-map/src/vision.rs",
  "src/map/mod.rs",
  "crates/foi-protocol/src/action.rs",
  "crates/foi-protocol/src/codec.rs",
  "crates/foi-protocol/src/commit.rs",
  "crates/foi-protocol/src/debrief.rs",
  "crates/foi-protocol/src/draft.rs",
  "crates/foi-protocol/src/error.rs",
  "crates/foi-protocol/src/history.rs",
  "crates/foi-protocol/src/intents.rs",
  "crates/foi-protocol/src/lib.rs",
  "crates/foi-protocol/src/message.rs",
  "crates/foi-protocol/src/observation.rs",
  "crates/foi-protocol/src/replay.rs",
  "crates/foi-protocol/src/transcript.rs",
  "src/protocol/mod.rs",
  ...
  "crates/foi-study/src/catalog.rs",
  "crates/foi-study/src/dimension.rs",
  "crates/foi-study/src/dimension_catalog.rs",
  "crates/foi-study/src/empirical_trials.rs",
  "crates/foi-study/src/empirical_trials_catalog.rs",
  "crates/foi-study/src/evaluation.rs",
  "crates/foi-study/src/finding.rs",
  "crates/foi-study/src/informal_check.rs",
  "crates/foi-study/src/interaction.rs",
  "crates/foi-study/src/lib.rs",
  "crates/foi-study/src/protocol.rs",
  "crates/foi-study/src/remediation.rs",
  "crates/foi-study/src/remediation_catalog.rs",
  "crates/foi-study/src/sampling.rs",
  "crates/foi-study/src/session.rs",
  "crates/foi-study/src/synthesis.rs",
  "crates/foi-study/src/synthesis_catalog.rs",
  "src/study/mod.rs",
)
