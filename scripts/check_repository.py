...
CORE_RUST_FILES = (
  ...
  "src/lane/mod.rs",
  "src/map/catalog.rs",
  "src/map/complete_match.rs",
  "src/map/complete_match_catalog.rs",
  "src/map/comeback.rs",
  "src/map/comeback_catalog.rs",
  "src/map/composition.rs",
  "src/map/contest.rs",
  "src/map/cost_profile.rs",
  ...
  "src/map/role_observation.rs",
  "src/map/state.rs",
  "src/map/structures.rs",
  "src/map/topology.rs",
  "src/map/transition.rs",
  "src/map/travel.rs",
  "src/map/victory.rs",
  "src/map/vision.rs",
