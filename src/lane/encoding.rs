...
pub(crate) const MAX_LANE_POTION: u8 = 5;
pub(crate) const MAX_LANE_ELIXIR: u8 = 5;
pub(crate) const MAX_LANE_TRINKET: u8 = 5;
pub(crate) const MAX_LANE_RELIC: u8 = 5;
pub(crate) const MAX_LANE_CHARM: u8 = 5;
pub(crate) const MAX_LANE_SCROLL: u8 = 5;
pub(crate) const MAX_LANE_TOME: u8 = 5;
pub(crate) const MAX_LANE_RUNE: u8 = 5;
pub(crate) const MAX_LANE_SIGIL: u8 = 5;
pub(crate) const MAX_LANE_TALISMAN: u8 = 5;
pub(crate) const MAX_LANE_AMULET: u8 = 5;
pub(crate) const MAX_LANE_PHIAL: u8 = 5;
pub(crate) const MAX_LANE_FLASK: u8 = 5;
pub(crate) const MAX_LANE_INCENSE: u8 = 5;
pub(crate) const MAX_LANE_SALVE: u8 = 5;
pub(crate) const MAX_LANE_POULTICE: u8 = 5;
...
pub(crate) const LANE_POTION_HASH_TAG: u8 = 0x4f;
pub(crate) const LANE_ELIXIR_HASH_TAG: u8 = 0x58;
pub(crate) const LANE_TRINKET_HASH_TAG: u8 = 0x52;
pub(crate) const LANE_RELIC_HASH_TAG: u8 = 0x59;
pub(crate) const LANE_CHARM_HASH_TAG: u8 = 0x48;
pub(crate) const LANE_SCROLL_HASH_TAG: u8 = 0x55;
pub(crate) const LANE_TOME_HASH_TAG: u8 = 0x4e;
pub(crate) const LANE_RUNE_HASH_TAG: u8 = 0x5a;
pub(crate) const LANE_SIGIL_HASH_TAG: u8 = 0x49;
pub(crate) const LANE_TALISMAN_HASH_TAG: u8 = 0x4a;
pub(crate) const LANE_AMULET_HASH_TAG: u8 = 0x61;
pub(crate) const LANE_PHIAL_HASH_TAG: u8 = 0x62;
pub(crate) const LANE_FLASK_HASH_TAG: u8 = 0x63;
pub(crate) const LANE_INCENSE_HASH_TAG: u8 = 0x64;
pub(crate) const LANE_SALVE_HASH_TAG: u8 = 0x65;
pub(crate) const LANE_POULTICE_HASH_TAG: u8 = 0x66;
