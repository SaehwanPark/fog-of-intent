...
impl PlayerLaneState {
    ...
    pub fn new_with_resources(
        ...
        Self::new_with_all_resources(id, health, mana, gold, LaneExperience::zero(), position)
    }
...
pub fn transition_lane(
    ...
    let after_player_experience = player.experience.add(execution.experience_gained).ok_or(
        LaneTransitionError::Execution(LaneExecutionError::ExperienceOverflow {
            gained: execution.experience_gained,
    ...
    let after_player_bounty =
        player
            .bounty
            .add(execution.bounty_earned)
            .ok_or(LaneTransitionError::Execution(
                LaneExecutionError::BountyOverflow {
                    earned: execution.bounty_earned,
                    current: player.bounty,
                },
            ))?;
    let after_player_level =
        player
            .level
            .add(execution.level_gained)
            .ok_or(LaneTransitionError::Execution(
                LaneExecutionError::LevelOverflow {
                    gained: execution.level_gained,
