...
- Integration tests in `tests/binary_run_dir.rs` verify that `--scenario m12-alpha-release-checks-v1` and `--scenario m12-reproducibility-bundle-v1` execute audits, render structured Markdown reports, verify 100% readiness/eligibility status, and exit cleanly with code 0.
